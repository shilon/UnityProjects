...
public class BotControlScript : MonoBehaviour
{
    ...
    static int walkState = Animator.StringToHash("Base Layer.Walks");
	static int runState = Animator.StringToHash("Base Layer.Runs");			// these integers are references to our animator's states
	...
	void FixedUpdate ()
	{
		...
		if (currentBaseState.fullPathHash == runState)
		{
            ...
            (currentBaseState.fullPathHash == walkState)
                {
